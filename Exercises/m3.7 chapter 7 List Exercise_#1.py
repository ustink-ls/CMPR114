...
#Project #1 (creating lists). A list is a container that can 
#hold character or number values. Instead of having to declare 
#multiple variables, we can use one variable and assign multiple 
#parameters.
