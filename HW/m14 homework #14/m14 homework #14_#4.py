#Class Exercise #4: Continuing from exercise #3, create 
...
class MyGUI:
    def __init__(self):
        ...
        #Create five IntVar objects to use with the Checkbuttons.
    ...
    #The show_chocie method is the callback function for the OK
    #button.
    def show_choice(self):
        # Create a message string. 
        self.message = 'You selected:\n'
        
        #Determine which Checkbuttons are selected and build 
